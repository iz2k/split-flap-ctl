...
from splitFlapBackend.webServer.routesInfo import defineInfoRoutes
...
class webServerThread(Thread):
    ...
    def define_webroutes(self, clk : Clock, weather : WeatherStation):
        defineInfoRoutes(self.flaskApp, self.sio)
        defineClockRoutes(self.flaskApp, self.sio, clk)
